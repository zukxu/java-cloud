package com.zukxu.flowable.dto;
...
public class ProcessDefinitionDTO implements Serializable {
    ...
    public ProcessDefinitionDTO(String id, String name, String key, String category, String formId, String formName, int version, String deploymentId, int suspensionState, Date deploymentTime) {
        this.id = id;
        this.name = name;
        this.key = key;
