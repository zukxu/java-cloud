package com.zukxu.search.config;
...
public class RestHighLevelClientConfig {
    ...
    public RestClientBuilder restClientBuilder() {
        ...
        restClientBuilder.setRequestConfigCallback(builder -> builder.setConnectTimeout(connectTimeOut).setSocketTimeout(socketTimeout));
