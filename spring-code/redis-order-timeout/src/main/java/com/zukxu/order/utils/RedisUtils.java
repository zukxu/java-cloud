...
public class RedisUtils {
	 ...
	 * @param key     键
	 * @param value   值
	 * @param timeout 过期时间 过期时间
	 * @param unit    过期时间单位    时间单位: 天:TimeUnit.DAYS 小时:TimeUnit.HOURS 分钟:TimeUnit.MINUTES
	 ...
	 * @param key   键
	 * @param value 值
	 * @return 返回值 之前已经存在返回false, 不存在返回true
	 */
	...
	/**
	 * 从偏移量 offset 开始，覆写key值
	 *
	 * @param key    键
	 * @param value  值
	 * @param offset 偏移量 从指定位置开始覆写
	 */
	...
	/**
	 * 以增量的方式将long值存储在变量中。 正数为(自增长), 负数则为自减
	 *
	 * @param key 键
	 * @return 返回值
	 */
	...
	/**
	 * 以增量的方式将Double值存储在变量中。 正数为(自增长), 负数则为自减
	 *
	 * @param key 键
	 * @return 返回值
	 */
	 ...
	 *
	 * @param key     键值
	 * @param timeout 过期时间 等待时间
	 * @param unit    过期时间单位    时间单位
	 * @return 返回值
	 */
	 ...
	 *
	 * @param key   键值
	 * @param index 索引值 index=0, 删除所有值等于value的元素; index>0, 从头部开始删除第一个值等于value的元素;
