...
public class ExcelUtil<T> {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StrUtil.endWith(s, ".0")) {
                            ...
                            if (StrUtil.isNotEmpty(dateFormat)) {
                                val = DateUtils.parseDate(String.valueOf((Date) val), dateFormat);
                            } else {
    ...
    public void exportExcel(HttpServletResponse response, List<T> list, String sheetName, String title) {
        ...
        response.setHeader("Content-Disposition", "attachment;fileName=" + new String(sheetName.getBytes(), StandardCharsets.UTF_8) + ".xlsx");
    ...
    public String exportExcel() {
        ...
        try {
            fos = new FileOutputStream(REPORT_PATH + fileName);
            writeSheet();
            wb.write(fos);
            fos.flush();
            fos.close();
    ...
    public int getImageType(byte[] value) {
        String type = FileUtil.getSuffix(Arrays.toString(value));
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StrUtil.isNotEmpty(dateFormat) && ObjectUtil.isNotNull(value)) {
                    cell.setCellValue(DateUtils.parseDate(String.valueOf((Date) value), dateFormat));
