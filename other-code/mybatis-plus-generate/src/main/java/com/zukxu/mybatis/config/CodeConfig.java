...
public class CodeConfig {
     ...
     * 注入配置
     */
    public static final InjectionConfig INJECTION_CONFIG = new InjectionConfig.Builder()
     ...
     * 策略配置
     */
    public static final StrategyConfig STRATEGY_CONFIG = new StrategyConfig.Builder()
    ...
    public static final StrategyConfig STRATEGY_CONFIG_ENTITY = new StrategyConfig.Builder()
            .entityBuilder()
    ...
    public static final StrategyConfig STRATEGY_CONFIG_CONTROLLER = new StrategyConfig.Builder()
            .controllerBuilder()
    ...
    public static final StrategyConfig STRATEGY_CONFIG_SERVICE = new StrategyConfig.Builder()
            .serviceBuilder()
     ...
     */
    public static final StrategyConfig STRATEGY_CONFIG_MAPPER = new StrategyConfig.Builder()
            .mapperBuilder()
            .superClass(BaseMapper.class)//父类配置
